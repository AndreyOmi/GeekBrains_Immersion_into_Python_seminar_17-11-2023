...
Для запуска из командной строки можно испльзовать следующий скрипт:
python homework_17-11-2023_task_1.py --MULTIPLICITY 100 --TAX_RATE 0.02 --TAX_MIN_LIMIT 50 --TAX_MAX_LIMIT 700
...
logging.basicConfig(filename='AO_log_17-11-2023.log', level=logging.INFO,
...
##### Функция для проверки текущих параметров работы банкомата
...
#### функция для парсинга аргументов при запуске из командной строки, например так:
#### python homework_17-11-2023_task_1.py --MULTIPLICITY 100 --TAX_RATE 0.02 --TAX_MIN_LIMIT 50 --TAX_MAX_LIMIT 700
...
if __name__ == "__main__":
    ...
    # Обновление параметров работы банкомата на основании аргументов командной строки
